              ...
              >
                  ...
                  {(field) => {
                    ...
                    return (
                      <field.NumberField
                        ...
                        variant="secondary"
                        isInvalid={isInvalid}
                        className="font-heading selection:bg-default mb-4 p-0 font-semibold selection:text-inherit"
                        fullWidth
                        formatOptions={{
                          currency: "PHP",
                            ...
                            <DatePicker.Popover className="flex flex-col gap-3">
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <TimeField
                                  ...
                                  granularity="minute"
                                  value={
                                    values.state.timeValue ?? new Time(0, 0)
                                  }
                                  onChange={(time) => {
                ...
                <form.AppField name="categoryId">
                  {(field) => {
                    ...
                    return (
                      <AsyncBoundary
                        classNames={{ base: "h-9", icon: "size-6" }}
                      >
